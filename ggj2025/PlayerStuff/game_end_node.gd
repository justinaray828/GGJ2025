...
func updateTheText(): 
	...
	$"../death_container/MarginContainer3/MarginContainer/VBoxContainer/HBoxContainer/time_alive".text = endplay
	$"../death_container/MarginContainer3/MarginContainer/VBoxContainer/HBoxContainer2/demons_banished".text = str(kill_count)
